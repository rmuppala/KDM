...
object Triplet
{
  ...
  def main(args: Array[String]) {
    ...
    val medlist = sc.textFile("output1/medlist.txt").distinct()
    ...
    import java.io._
    val pw = new PrintWriter(new File("output1/tripletnew.txt" ))
    val pwt = new PrintWriter(new File("output1/triplets.txt" ))
    val pws = new PrintWriter(new File("output1/subnew.txt" ))
    val pwp = new PrintWriter(new File("output1/prednew.txt" ))
    val pwo = new PrintWriter(new File("output1/objnew.txt" ))
